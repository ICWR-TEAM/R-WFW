...
define(constant_name: 'DEV_DB_HOST', value: 'incrustwerush.org');
define(constant_name: 'DEV_DB_USER', value: 'incrustwerush.org');
define(constant_name: 'DEV_DB_PASS', value: 'incrustwerush.org');
define(constant_name: 'DEV_DB_NAME', value: 'incrustwerush.org');

// Database

define(constant_name: 'BASEURL', value: 'http://localhost');
